...
module.exports=async(req,res)=>{
 ...
 try{
  ...
  return res.status(201).json({dateLabel:begins.toLocaleDateString("en-KE",{weekday:"long",day:"numeric",month:"long",year:"numeric",timeZone:"Africa/Nairobi"}),timeLabel:begins.toLocaleTimeString("en-KE",{hour:"numeric",minute:"2-digit",timeZone:"Africa/Nairobi"}),invitationSent:event.invitationSent});
